...
public class JsonDaoNew<T extends AbstractBusinessObject> extends DAO {
    ...
    */
    ...
    public static final Logger log = Logger.getLogger(JsonDaoNew.class);

    private HashMap<Class, HashMap<BigInteger, T>> dataMap;
    private HashMap<Class, HashMap<BigInteger, T>> dataMapTest;
    ...
    public JsonDaoNew() {
        ...
        HashMap userMap = jsonDeserializeBObjectByType(User.class, SerializationConstants.SERIALIZED_USERMAP_FILE_PATH);
        if (userMap != null) {
        ...
        HashMap folderMap = jsonDeserializeBObjectByType(Folder.class, SerializationConstants.SERIALIZED_FOLDERMAP_FILE_PATH);
        if (folderMap != null) {
        ...
        HashMap itemMap = jsonDeserializeBObjectByType(Item.class, SerializationConstants.SERIALIZED_ITEMMAP_FILE_PATH);
        if (itemMap != null) {
        ...
        HashMap orderMap = jsonDeserializeBObjectByType(Order.class, SerializationConstants.SERIALIZED_ORDERMAP_FILE_PATH);
        if (orderMap != null) {
...
//                }
    ...
    @Override
    public <T extends AbstractBusinessObject> Map getMapShardByABOName(Class<T> abObjType) {
        //log.info(abObjType);
...
//        }
    ...
    private HashMap jsonDeserializeBObjectByType(Class abObjType, String serializedFileName) {
...
//    }
    ...
    private  HashMap jsonDeserializeEntireDataStructure(String serializedFileName) {

        HashMap<Class<T>, HashMap<BigInteger, T>> emptyDataMap = new HashMap<>();
        File serializedObjectFile = new File(serializedFileName);
        if (serializedObjectFile.exists() && !serializedObjectFile.isDirectory()) {
            ...
            try {
                ...
                BufferedReader br = new BufferedReader(new FileReader(serializedFileName));
                Type mapType = new TypeToken<HashMap<Class, HashMap<BigInteger, T>>>(){}.getType();

                HashMap<Class, HashMap<BigInteger, T>> dataMap = gson.fromJson(br, mapType);
                return dataMap;
